...
abstract class Driver
{
     ...
     * @param bool $merge 是否合并,默认false会覆盖之前绑定的参数
     * @return bool 返回false说明绑定失败
     */
    public function setBind($params = array(), $merge = false)
    {
        if (!is_array($params)) {
            return false;
        }
        $this->bind = $merge == true ? array_merge($this->bind, $params) : $params;
        return true;
    }
